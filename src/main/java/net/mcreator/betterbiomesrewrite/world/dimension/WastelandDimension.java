...
package net.mcreator.betterbiomesrewrite.world.dimension;
...
import net.mcreator.betterbiomesrewrite.item.WastelandItem;
...
public class WastelandDimension extends BetterbiomesrewriteModElements.ModElement {
	@ObjectHolder("betterbiomesrewrite:wasteland_portal")
	public static final CustomPortalBlock portal = null;
	public WastelandDimension(BetterbiomesrewriteModElements instance) {
		super(instance, 7);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("betterbiomesrewrite:wasteland"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("betterbiomesrewrite:wasteland"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("betterbiomesrewrite:wasteland")));
				} else {
					entity.func_242279_ag();
	...
	public static class CustomPortalSize {
		private static final AbstractBlock.IPositionPredicate POSITION_PREDICATE = (state, blockReader, pos) -> {
			return state.getBlock() == Blocks.NETHER_BRICKS.getDefaultState().getBlock();
		};
					...
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0
									? Blocks.NETHER_BRICKS.getDefaultState().getBlock().getDefaultState()
									: Blocks.AIR.getDefaultState();
			...
			for (int k1 = -1; k1 < 3; ++k1) {
				for (int i2 = -1; i2 < 4; ++i2) {
					if (k1 == -1 || k1 == 2 || i2 == -1 || i2 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, Blocks.NETHER_BRICKS.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
