...
package net.mcreator.betterbiomesrewrite.world.biome;
...
import net.mcreator.betterbiomesrewrite.block.SakuraLogBlock;
...
public class SakuraForestBiome extends BetterbiomesrewriteModElements.ModElement {
	public static Biome biome;
	public SakuraForestBiome(BetterbiomesrewriteModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-6697729).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-26113).withGrassColor(-16724890).build();
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.PLAINS).depth(0.1f).scale(0.2f)
						.temperature(1.1f).downfall(0.7f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("betterbiomesrewrite:sakura_forest"));
			}
		}
	}
	@Override
