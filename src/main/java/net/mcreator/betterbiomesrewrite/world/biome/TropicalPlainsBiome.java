...
public class TropicalPlainsBiome extends BetterbiomesrewriteModElements.ModElement {
	public static Biome biome;
	public TropicalPlainsBiome(BetterbiomesrewriteModElements instance) {
		super(instance, 10);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-10027009).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-13382656).withGrassColor(-13382656).build();
				...
				event.getRegistry().register(biome.setRegistryName("betterbiomesrewrite:tropical_plains"));
			}
		}
	}
	@Override
