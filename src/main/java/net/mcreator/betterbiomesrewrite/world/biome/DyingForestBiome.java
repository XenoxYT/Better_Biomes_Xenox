...
public class DyingForestBiome extends BetterbiomesrewriteModElements.ModElement {
	public static Biome biome;
	public DyingForestBiome(BetterbiomesrewriteModElements instance) {
		super(instance, 60);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-3355648).setWaterFogColor(-3355648)
				...
				event.getRegistry().register(biome.setRegistryName("betterbiomesrewrite:dying_forest"));
			}
		}
	}
	@Override
